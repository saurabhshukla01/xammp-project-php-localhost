      ...
      <header class="header-bg">
         <div class="container">
            <nav class="navbar navbar-expand-md navbar-light">
               <a href="index.html" class="navbar-brand"><img src="http://localhost/callupon/assets/images/callupon_logo.png" alt="" style="width:250px;" /></a>
               ...
               <div class="collapse navbar-collapse" id="navbarCollapse">
                  <div class="navbar-nav ml-auto">
                     ...
                     <a href="my-petition.html" class="nav-item nav-link p-3">START PETITION</a>
                     <a href="browse.html" class="nav-item nav-link p-3">MY PETITION</a>
                     <a href="support.html" class="nav-item nav-link p-3">BROWSE</a>
                  </div>
            ...
            <div class="row">
               ...
               <div class=" col-sm-4 col-md  col-6 col">
                  ...
                  <ul class="footer_ul_amrc">
                     ...
                     <li><a href="">Lorem ipsum Lorem Lorem ipsum </a></li>
                     <li><a href="">Lorem ipsum </a></li>
                     <li><a href="">Lorem ipsum LoremLorem ipsum Lorem</a></li>
                     <li><a href="">Lorem ipsum Lorem Lorem </a></li>
                     <li><a href="">Lorem ipsum Lorem</a></li>
                  </ul>
               ...
               <div class=" col-sm-4 col-md  col-12 col">
                  ...
                  <ul class="footer_ul2_amrc">
                     <li>
                        ...
                        <p>Lorem Ipsum is simply dummy text of the printing...<a href="#" class="text-primary">https://www.lipsum.com/</a></p>
                     </li>
                     <li>
                        <a href="#"><i class="fa fa-twitter fleft padding-right text-white"></i> </a>
                        <p>Lorem Ipsum is simply dummy text of the printing...<a href="#" class="text-primary">https://www.lipsum.com/</a></p>

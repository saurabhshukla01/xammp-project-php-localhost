...
<div id="container">
	<div id="left"><br><br><br>
		...
		<br>
		<h3 style="color: red;margin-left: 50px">Popular Books</h3>
		<div id="a"><center><img src="img/r1.jpg"></center></div>
		<div id="b"><center><img src="img/r3.jpg"></center></div>
		<div id="c"><center><img src="img/r4.jpg"></center></div>
	</div>
    <div id="right">

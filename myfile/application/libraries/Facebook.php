...
require_once '/home/callupon/public_html/vendor/autoload.php'; 
...
Class Facebook
{
    ...
    public function login_url() {
        ...
        //echo $this->config->item('facebook_login_redirect_url');
    ...
    public function post($attachment) {
        ...
        $this->fb->post('/me/feed', $attachment, $accessToken);
    }

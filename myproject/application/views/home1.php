		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-3 wow fadeInDown" data-wow-delay="1.1s">
				<div class="service-content text-center">
					...
					<p>Neutra Thundercats craft beer, listicle meggings bicycle rights 90  XOXO beard cardiga</p>
				</div>
			</div>
			<!--/ End Third service -->
				...
				<div class="grid">
					<figure class="m-0 effect-oscar">
						...
						<figcaption>
							...
							<a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
							<a class="view icon-pentagon" data-rel="prettyPhoto" href="../../assets/images/portfolio/portfolio-bg2.jpg"><i
									class="fa fa-search"></i></a>
						</figcaption>
					</figure>
				</div>
				...
				<div class="grid">
					<figure class="m-0 effect-oscar">
						...
						<figcaption>
							<h3>Your Business</h3>
							<a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
							<a class="view icon-pentagon" data-rel="prettyPhoto" href="../../assets/images/portfolio/portfolio-bg3.jpg"><i
									class="fa fa-search"></i></a>
						</figcaption>
					</figure>
				</div>
				...
				<div class="grid">
					<figure class="m-0 effect-oscar">
						...
						<figcaption>
							<h3>Prego Match</h3>
							<a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
							<a class="view icon-pentagon" data-rel="prettyPhoto" href="../../assets/images/portfolio/portfolio-bg4.jpg"><i
									class="fa fa-search"></i></a>
						</figcaption>
					</figure>
				</div>
				...
				<div class="grid">
					<figure class="m-0 effect-oscar">
						...
						<figcaption>
							<h3>Fashion Brand</h3>
							<a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
							<a class="view icon-pentagon" data-rel="prettyPhoto" href="../../assets/images/portfolio/portfolio-bg5.jpg"><i
									class="fa fa-search"></i></a>
						</figcaption>
					</figure>
				</div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-6 ts-padding"
				style="height:650px;background:url(../../assets/images/image-block-bg.jpg) 50% 50% / cover no-repeat;">
			</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 text-center">
				...
				<h3>Just Click Button and Used Your Own</h3>
				<p>
...
<!-- CD Hero slider -->
<script type="text/javascript" src="../../assets/plugins/cd-hero/cd-hero.js"></script>
<!-- Isotope -->

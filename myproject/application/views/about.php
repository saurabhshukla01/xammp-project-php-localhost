...
<head>
  ...
  <!-- Bootstrap -->
  <link rel="stylesheet" href="<?php= base_url ('assets/plugins/bootstrap/bootstrap.min.css'); ?>">
	<!-- FontAwesome -->
  <link rel="stylesheet" href="<?php= base_url ('assets/plugins/fontawesome/font-awesome.min.css'); ?>">
	<!-- Animation -->
	<link rel="stylesheet" href="<?php= base_url ('assets/plugins/animate.css'); ?>">
	<!-- Prettyphoto -->
	<link rel="stylesheet" href="<?php= base_url ('assets/plugins/prettyPhoto.css'); ?>">
	<!-- Owl Carousel -->
	<link rel="stylesheet" href="<?php= base_url ('assets/plugins/owl/owl.carousel.css'); ?>">
	<link rel="stylesheet" href="<?php= base_url ('assets/plugins/owl/owl.theme.css'); ?>">
	<!-- Flexslider -->
	<link rel="stylesheet" href="<?php= base_url ('assets/plugins/flex-slider/flexslider.css'); ?>">
	<!-- Flexslider -->
	<link rel="stylesheet" href="<?php= base_url ('assets/plugins/cd-hero/cd-hero.css'); ?>">
	<!-- Style Swicther -->
	<link id="style-switch" href="<?php= base_url ('assets/css/presets/preset3.css'); ?>" media="screen" rel="stylesheet" type="text/css">

	<!-- HTML5 shim, for IE6-8 support of HTML5 elements. All other JS at the end of file. -->
    <!--[if lt IE 9]>
      <script src="<?php= base_url ('assets/plugins/html5shiv.js'); ?>"></script>
      <script src="<?php= base_url ('assets/plugins/respond.min.js'); ?>"></script>
    <![endif]-->
  ...
  <!--Favicon-->
	<link rel="icon" href="<?php= base_url ('assets/img/favicon/favicon-32x32.png'); ?>" type="image/x-icon" />
	<link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php= base_url ('assets/img/favicon/favicon-144x144.png'); ?>">
	<link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php= base_url ('assets/img/favicon/favicon-72x72.png'); ?>">
	<link rel="apple-touch-icon-precomposed" href="<?php= base_url ('assets/img/favicon/favicon-54x54.png'); ?>">
...
<header id="header" class="fixed-top header" role="banner">
	<a class="navbar-brand navbar-bg" href="index.html"><img class="img-fluid float-right" src="<?php= base_url ('assets/images/logo.png'); ?>" alt="logo"></a>
	<div class="container">
...
<section id="home" class="p-0">
	<div id="main-slide" class="cd-hero">
		<ul class="cd-hero-slider">
			<li class="selected">
				<div class="overlay2">
					<img class="" src="<?php= base_url ('assets/images/slider/bg1.jpg'); ?>" alt="slider">
				</div>
			...
			<li>
				<div class="overlay2">
					<img class="" src="<?php= base_url ('assets/images/slider/bg2.jpg'); ?>" alt="slider">
				</div>
				...
				<div class="cd-half-width cd-img-container">
					<img src="<?php= base_url ('assets/images/slider/bg-thumb1.png'); ?>" alt="">
				</div> <!-- .cd-half-width.cd-img-container -->
			</li>
			<li>
				<div class="overlay2">
					<img class="" src="<?php= base_url ('images/slider/bg3.jpg'); ?>" alt="slider">
				</div>
				<div class="cd-half-width cd-img-container img-right">
					<img src="<?php= base_url ('assets/images/slider/bg-thumb2.png'); ?>" alt="">
				</div> <!-- .cd-half-width.cd-img-container -->
				<div class="cd-half-width">

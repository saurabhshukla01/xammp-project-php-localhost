...
<h2 align="center"> This is Insert Table Data from User Input Show In PHP File All DB Table Data </h2>
	<form method="post" action="imagepost.php" enctype="multipart/form-data">

		<table border="1" width="60%" align="center">
		<tr>
			<td>Name</td>
			<td><input style="width: 770px; height: 40px; margin: 0px;" type="text" placeholder="Enter the Email" name="name" required/></td>
		</tr>
		<tr>
			<td>Email</td>
